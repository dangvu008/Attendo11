...
export default function WorkScheduleScreen({ navigation }) {
  ...
  const handleApplyShift = (shift) => {
    if (!shift || !shift.id) {
      Alert.alert(
        t("error") || "Error",
        t("invalid_shift_data") || "Invalid shift data. Please try again."
      );
      return;
    }
                    ...
                    (day, index) => (
                      <View
                        ...
                        style={[
                          ...
                          {
                            backgroundColor:
                              currentShift.daysApplied &&
                              currentShift.daysApplied[index]
                                ? "#6a5acd"
                                : darkMode
                                ? "#2d2d2d"
                                : "#f0f0f0",
